<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Applyleaveheadoffice.aspx.cs" Inherits="ManPowerWeb.applyleaveheadoffice" %>
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Leave Type" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="table-dark">
                                <ItemTemplate>
                                    ...
                                    <asp:Label runat="server" Visible='<%#Eval("LeaveTypeId").ToString() == "7" ?true:false %>' Text="Lapsed Leave"> </asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
