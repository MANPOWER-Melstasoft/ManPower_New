...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="table-responsive" style="width: 100%; padding-left: 40px; padding-right: 40px;">
        <asp:GridView Style="margin-top: 30px;" ID="gvDepartment" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered"
            CellPadding="4" GridLines="None" AllowPaging="true" OnPageIndexChanging="GridView1_PageIndexChanging">
            <Columns>
                <asp:BoundField DataField="DepartmentUnitId" HeaderText="ID" HeaderStyle-CssClass="table-dark" />
                ...
                <asp:BoundField DataField="AddressLine1" HeaderText="ADDRESS LINE 1" HeaderStyle-CssClass="table-dark" />
                <asp:BoundField DataField="AddressLine2" HeaderText="ADDRESS LINE 2" HeaderStyle-CssClass="table-dark" />
                <asp:BoundField DataField="AddressLine1" HeaderText="ADDRESS LINE 3" HeaderStyle-CssClass="table-dark" />
                <asp:BoundField DataField="ParentId" HeaderText="PARENT ID" HeaderStyle-CssClass="table-dark" />
            </Columns>
        </asp:GridView>
    </div>
