...
namespace ManPowerCore.Domain
{
	...
	public class VehicleMeintenance
	{
		...
		[DBField("Recommend_AD")]
		public int RecommendADBy { get; set; }

		[DBField("Recommend_AD_Date")]
		public DateTime RecommendADDate { get; set; }

		[DBField("Recommend_Director")]
		public int RecommendDBy { get; set; }

		[DBField("Recommend_Director_Date")]
		public DateTime RecommendDDate { get; set; }
