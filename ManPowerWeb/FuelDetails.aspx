...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        <div class="card p-4">
            ...
            <div class="row mt-3">
                <div class="col-sm-3">
                    <asp:Literal ID="Literal5" runat="server" Text="Employee Name"></asp:Literal>
                </div>

                <div class="col-md-4">
                    <asp:DropDownList ID="ddlEmployee" runat="server" CssClass="form-control form-control-user"></asp:DropDownList>
