<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RecommendNextTransfersRetirementResignationView.aspx.cs" Inherits="ManPowerWeb.RecommendNextTransfersRetirementResignationView" %>
                    ...
                    <ContentTemplate>
                        ...
                        <div class="row mb-5">
                            <div class="col-sm-6">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <asp:Literal ID="Literal23" runat="server" Text="Recommendation Documnents"></asp:Literal>
                                    </div>
                                    <div class="col-md-4">
