...
namespace ManPowerCore.Infrastructure
{
    ...
    public class DistressLoanDAOSqlImpl : DistressLoanDAO
    {
        public int Save(DistressLoan distressLoan, DBConnection dbConnection)
        {
            ...
            dbConnection.cmd.CommandText = "INSERT INTO Distress_Loan (Loan_Details_Id, Reason_For_Loan,  Last_Loan_Date) " +
                                "VALUES (@LoanDetailsId, @ReasonForLoan,@LastLoanDate) SELECT SCOPE_IDENTITY()";
