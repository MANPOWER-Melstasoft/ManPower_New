...
namespace ManPowerWeb
{
    public partial class ApproveLeave : System.Web.UI.Page
    {
        ...
        private void bindDataSource()
        {
            ...
            try
            {
                staffLeaveList = staffLeaveList.Where(x => x.LeaveStatusId == 3 && (x.systemUser.UserTypeId == 1 || x.systemUser.UserTypeId == 2
                || x.systemUser.UserTypeId == 3 || x.systemUser.UserTypeId == 4 || x.systemUser.UserTypeId == 5 || x.systemUser.UserTypeId == 10
                || x.systemUser.UserTypeId == 11 || x.systemUser.UserTypeId == 12 || x.systemUser.UserTypeId == 13 || x.systemUser.UserTypeId == 14
                || x.systemUser.UserTypeId == 15)).ToList();
