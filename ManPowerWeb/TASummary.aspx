...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Target Achievement - Individual Progress</h2>
    <div class="row mb-5">
        <div class="card">
            <div class="table-responsive">
                <asp:GridView ID="gvTAIndividualSummary" runat="server" CssClass="table table-bordered" AutoGenerateColumns="False"
