<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PaymentVoucherFinancePayment.aspx.cs" Inherits="ManPowerWeb.PaymentVoucherFinancePayment" %>
        ...
        <div class="card-body">
            ...
            <div>
                <div class="row mb-3  mt-5">
                    ...
                    <asp:Button ID="btnApprove" runat="server" Text="Paid" CssClass="btn btn-success btn-user " OnClick="btnApprove_Click" />
                </div>
            </div>
