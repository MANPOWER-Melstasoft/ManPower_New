        ...
        <div class="row">
            ...
            <div class="col-9">
                <asp:DropDownList ID="ddlProgramName" Width="230px" runat="server" AutoPostBack="true" CssClass="btn  btn-primary dropdown-toggle dropdown-toggle-split"
                    OnSelectedIndexChanged="ddlProgram_SelectedIndexChanged" data-bs-toggle="dropdown" aria-expanded="false">
                </asp:DropDownList>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-9">
                <asp:DropDownList ID="ddlResourcePerson" Width="230px" runat="server" AutoPostBack="true" Class="btn  btn-primary dropdown-toggle"
                    OnSelectedIndexChanged="ddlResourcePerson_SelectedIndexChanged" data-bs-toggle="dropdown" aria-expanded="false">
                </asp:DropDownList>
            </div>
        </div>
        <br />
