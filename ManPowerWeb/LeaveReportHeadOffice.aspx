<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LeaveReportHeadOffice.aspx.cs" Inherits="ManPowerWeb.LeaveReportHeadOffice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="card">
        ...
        <h2 style="text-align: center; margin-bottom: 40px; margin-top: 30px;">Leave Report Head Office</h2>
