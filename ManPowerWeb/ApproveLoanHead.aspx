<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ApproveLoanHead.aspx.cs" Inherits="ManPowerWeb.ApproveLoanHead" %>
            ...
            <div class="row mb-3 ms-1 mt-4">
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control form-control-user" TextMode="Date" Enabled="true"></asp:TextBox>
            ...
            <div class="row mb-3 ms-1 mt-3">
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <asp:DropDownList ID="ddlMonth" runat="server" CssClass="form-control form-control-user" TextMode="Date" Enabled="true"></asp:DropDownList>
