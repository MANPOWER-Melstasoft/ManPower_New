...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>View Vacancy Registration Details </h2>
		...
		<div class="row">
			...
			<div class="col-8">
				<asp:TextBox ID="link" runat="server" name="place" Width="250px" CssClass="form-control form-control-user" ></asp:TextBox>
			</div>
		</div>
		<br/> 
		...
		<div class="row">
			...
			<div class="col-8">
				<asp:TextBox ID="highestPsition" runat="server" name="place" Width="250px" CssClass="form-control form-control-user"></asp:TextBox>
			</div>
		</div><br />
		...
		<div class="row">
			...
			<div class="col-8">
				<asp:TextBox ID="level" runat="server" name="place" Width="250px" CssClass="form-control form-control-user"></asp:TextBox>
			</div>
		</div><br /> 
